...
public class SafetyService {
	...
	public String requestHospitalApi() throws IOException {
		...
		sb.append("?serviceKey=76V7739Y0UQD4863");
	...
	public String requestMessage(int pageNo) {
		...
		final String SERVICE_KEY = "R037H40OZQMUMME6";
	...
	public String getItems(String query) {
        String clientId = "SPnkm3kLTgkvYndP1YxS"; //애플리케이션 클라이언트 아이디
        String clientSecret = "qvBCwxfSWv"; //애플리케이션 클라이언트 시크릿
